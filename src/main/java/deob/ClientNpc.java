...
public final class ClientNpc extends ClientEntity {
	...
	public Model method109() {
		...
		if (super.field430 != -1 && super.field431 != -1) {
			...
			if (var3 != null) {
				...
				Model var5 = new Model(true, AnimFrame.method48(var4), var3, true, false);
	...
	public Model method115() {
		...
		int var1 = SeqType.field1133[super.field425].field1135[super.field426];
		int var2 = -1;
		if (super.field422 >= 0 && super.field422 != super.field402) {
			var2 = SeqType.field1133[super.field422].field1135[super.field423];
		}
		return this.field453.method337(var1, var2, SeqType.field1133[super.field425].field1139);
	}
