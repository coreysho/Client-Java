...
public final class Pix32 extends Pix2D {
	...
	public Pix32(JagFile arg0, String arg1, int arg2) {
		...
		var5.data = var4.g2();
		this.field666 = var5.g2();
		this.field667 = var5.g2();
		int var6 = var5.g1();
		...
		this.field664 = var5.g1();
		this.field665 = var5.g1();
		this.field662 = var5.g2();
		this.field663 = var5.g2();
		int var10 = var5.g1();
		int var11 = this.field662 * this.field663;
		this.field661 = new int[var11];
		if (var10 == 0) {
			for (int var12 = 0; var12 < var11; var12++) {
				this.field661[var12] = var7[var4.g1()];
			}
		} else if (var10 == 1) {
			for (int var13 = 0; var13 < this.field662; var13++) {
				for (int var14 = 0; var14 < this.field663; var14++) {
					this.field661[var13 + var14 * this.field662] = var7[var4.g1()];
				}
			}
		}
	}
	...
	public void method180(boolean arg0) {
		...
		Pix2D.method151(this.field662, this.field663, this.field661);
	}
	...
	public void method183(int arg0, int arg1) {
		...
		int var5 = var3 + var4 * Pix2D.field616;
		int var6 = 0;
		int var7 = this.field663;
		int var8 = this.field662;
		int var9 = Pix2D.field616 - var8;
		int var10 = 0;
		if (var4 < Pix2D.field618) {
			int var11 = Pix2D.field618 - var4;
			var7 -= var11;
			var4 = Pix2D.field618;
			var6 = var11 * var8;
			var5 += var11 * Pix2D.field616;
		}
		if (var4 + var7 > Pix2D.field619) {
			var7 -= var4 + var7 - Pix2D.field619;
		}
		if (var3 < Pix2D.field620) {
			int var12 = Pix2D.field620 - var3;
			var8 -= var12;
			var3 = Pix2D.field620;
			var6 += var12;
			var5 += var12;
		...
		if (var3 + var8 > Pix2D.field621) {
			int var13 = var3 + var8 - Pix2D.field621;
			var8 -= var13;
			var10 += var13;
			var9 += var13;
		}
		if (var8 > 0 && var7 > 0) {
			this.method184(var10, var6, this.field661, this.field652, var7, var8, var9, var5, Pix2D.field615);
		}
	}
	...
	public void method185(byte arg0, int arg1, int arg2) {
		...
		if (var10 > 0 && var9 > 0) {
			this.method186(Pix2D.field615, this.field661, var7, var6, var10, var9, var11, var12);
		}
	}
	...
	public void method187(int arg0, int arg1) {
		...
		if (var8 > 0 && var7 > 0) {
			this.method188(var9, var10, var8, Pix2D.field615, var5, this.field656, var6, var7, this.field661);
		}
	}
	...
	public void method189(int arg0, int arg1, int arg2, int arg3, int arg4, int[] arg5, int arg6, int[] arg7, int arg8, int arg9) {
		try {
			...
			int var19 = arg4 + arg9 * Pix2D.field616;
			for (int var20 = 0; var20 < arg3; var20++) {
				...
				for (int var25 = -arg5[var20]; var25 < 0; var25++) {
					Pix2D.field615[var22++] = this.field661[(var23 >> 16) + (var24 >> 16) * this.field662];
					var23 += var16;
					var24 -= var15;
				}
				var17 += var15;
	...
	public void method190(int arg0, int arg1, double arg2) {
		try {
			...
			int var11 = arg0 + arg1 * Pix2D.field616;
	...
	public void method191(int arg0, Pix8 arg1, int arg2) {
		...
		if (var9 > 0 && var8 > 0) {
			this.method192(Pix2D.field615, var6, var7, var8, var11, var9, arg1.field675, var10, this.field661);
		}
	}
