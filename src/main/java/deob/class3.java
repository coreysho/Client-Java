...
public final class class3 {
	...
	public static boolean method16(byte[] arg0, int arg1, int arg2) {
		boolean var3 = true;
		class38 var4 = new class38(arg0, (byte) 1);
		int var5 = -1;
		label50: while (true) {
			...
			while (true) {
				while (!var8) {
					...
					if (var14 > 0 && var15 > 0 && var14 < 103 && var15 < 103) {
						class57 var16 = class57.method325(var5);
	...
	public static void method17(class38 arg0, class47 arg1) {
		int var2 = -1;
		while (true) {
			...
			var2 += var3;
			class57 var4 = class57.method325(var2);
			var4.method330(arg1);
			while (true) {
	...
	public static int method24(int arg0, int arg1, int arg2, int arg3) {
		int var4 = 65536 - class34.field638[arg2 * 1024 / arg3] >> 1;
	...
	public static boolean method30(int arg0, int arg1) {
		class57 var2 = class57.method325(arg0);
		if (arg1 == 11) {
			arg1 = 10;
		}
		if (arg1 >= 5 && arg1 <= 8) {
	...
	public static void method31(class18 arg0, int arg1, int arg2, boolean arg3, int arg4, int arg5, int arg6, class62 arg7, int[][][] arg8, int arg9, int arg10) {
		...
		class57 var16 = class57.method325(arg4);
		...
		if (arg5 == 22) {
			...
			if (var16.field968 == -1) {
				...
				var19 = new class28(22, arg6, var16.field968, arg4, var13, field41, true, var12, var14, var11);
			}
			...
			if (var16.field968 == -1) {
				...
				var20 = new class28(10, arg6, var16.field968, arg4, var13, field41, true, var12, var14, var11);
			}
			if (var20 != null) {
				int var21 = 0;
				if (arg5 == 11) {
			...
			if (var16.field968 == -1) {
				...
				var24 = new class28(arg5, arg6, var16.field968, arg4, var13, field41, true, var12, var14, var11);
			}
			...
			if (var16.field968 == -1) {
				...
				var25 = new class28(0, arg6, var16.field968, arg4, var13, field41, true, var12, var14, var11);
			}
			...
			if (var16.field968 == -1) {
				...
				var26 = new class28(1, arg6, var16.field968, arg4, var13, field41, true, var12, var14, var11);
			}
			...
			if (var16.field968 == -1) {
				...
				var28 = new class28(2, arg6 + 4, var16.field968, arg4, var13, field41, true, var12, var14, var11);
				var29 = new class28(2, var27, var16.field968, arg4, var13, field41, true, var12, var14, var11);
			}
			...
			if (var16.field968 == -1) {
				...
				var30 = new class28(3, arg6, var16.field968, arg4, var13, field41, true, var12, var14, var11);
			}
			...
			if (var16.field968 == -1) {
				...
				var31 = new class28(arg5, arg6, var16.field968, arg4, var13, field41, true, var12, var14, var11);
			}
			...
			if (arg5 == 4) {
				...
				if (var16.field968 == -1) {
					...
					var36 = new class28(4, 0, var16.field968, arg4, var13, field41, true, var12, var14, var11);
				}
				...
				if (var38 > 0) {
					var37 = class57.method325(var38 >> 14 & 0x7FFF).field969;
				}
				class24 var39;
				if (var16.field968 == -1) {
					var39 = var16.method331(4, 0, var11, var12, var13, var14, -1);
				} else {
					var39 = new class28(4, 0, var16.field968, arg4, var13, field41, true, var12, var14, var11);
				}
				...
				if (var16.field968 == -1) {
					...
					var40 = new class28(4, 0, var16.field968, arg4, var13, field41, true, var12, var14, var11);
				}
				...
				if (var16.field968 == -1) {
					...
					var41 = new class28(4, 0, var16.field968, arg4, var13, field41, true, var12, var14, var11);
				}
				...
				if (var16.field968 == -1) {
					...
					var42 = new class28(4, 0, var16.field968, arg4, var13, field41, true, var12, var14, var11);
				}
	...
	public class3(int arg0, int[][][] arg1, int arg2, int arg3, byte[][][] arg4) {
		this.field46 = arg1;
		this.field47 = arg4;
	...
	public void method15(int arg0, byte[] arg1, int arg2, int arg3, int arg4) {
		class38 var6 = new class38(arg1, (byte) 1);
	...
	public void method18(int arg0, byte[] arg1, class18 arg2, int arg3, class62[] arg4) {
		class38 var6 = new class38(arg1, (byte) 1);
		int var7 = -1;
		while (true) {
	...
	public void method19(int arg0, class62 arg1, int arg2, int arg3, int arg4, class18 arg5, int arg6, int arg7) {
		if (field42) {
		...
		class57 var14 = class57.method325(arg6);
		...
		if (arg3 == 22) {
			if (!field42 || var14.field964 || var14.field984) {
				...
				if (var14.field968 == -1) {
					...
					var17 = new class28(22, arg2, var14.field968, arg6, var11, field41, true, var10, var12, var9);
				}
			...
			if (var14.field968 == -1) {
				...
				var18 = new class28(10, arg2, var14.field968, arg6, var11, field41, true, var10, var12, var9);
			}
			if (var18 != null) {
				int var19 = 0;
				if (arg3 == 11) {
			...
			if (var14.field968 == -1) {
				...
				var26 = new class28(arg3, arg2, var14.field968, arg6, var11, field41, true, var10, var12, var9);
			}
			...
			if (var14.field968 == -1) {
				...
				var27 = new class28(0, arg2, var14.field968, arg6, var11, field41, true, var10, var12, var9);
			}
			...
			if (var14.field968 == -1) {
				...
				var28 = new class28(1, arg2, var14.field968, arg6, var11, field41, true, var10, var12, var9);
			}
			...
			if (var14.field968 == -1) {
				...
				var30 = new class28(2, arg2 + 4, var14.field968, arg6, var11, field41, true, var10, var12, var9);
				var31 = new class28(2, var29, var14.field968, arg6, var11, field41, true, var10, var12, var9);
			}
			...
			if (var14.field968 == -1) {
				...
				var32 = new class28(3, arg2, var14.field968, arg6, var11, field41, true, var10, var12, var9);
			}
			...
			if (var14.field968 == -1) {
				...
				var33 = new class28(arg3, arg2, var14.field968, arg6, var11, field41, true, var10, var12, var9);
			}
			...
			if (arg3 == 4) {
				...
				if (var14.field968 == -1) {
					...
					var38 = new class28(4, 0, var14.field968, arg6, var11, field41, true, var10, var12, var9);
				}
				...
				if (var40 > 0) {
					var39 = class57.method325(var40 >> 14 & 0x7FFF).field969;
				}
				class24 var41;
				if (var14.field968 == -1) {
					var41 = var14.method331(4, 0, var9, var10, var11, var12, -1);
				} else {
					var41 = new class28(4, 0, var14.field968, arg6, var11, field41, true, var10, var12, var9);
				}
				...
				if (var14.field968 == -1) {
					...
					var42 = new class28(4, 0, var14.field968, arg6, var11, field41, true, var10, var12, var9);
				}
				...
				if (var14.field968 == -1) {
					...
					var43 = new class28(4, 0, var14.field968, arg6, var11, field41, true, var10, var12, var9);
				}
				...
				if (var14.field968 == -1) {
					...
					var44 = new class28(4, 0, var14.field968, arg6, var11, field41, true, var10, var12, var9);
				}
	...
	public void method20(class62[] arg0, class18 arg1) {
			...
			for (int var22 = -5; var22 < this.field44 + 5; var22++) {
				for (int var23 = 0; var23 < this.field45; var23++) {
					...
					if (var24 >= 0 && var24 < this.field44) {
						...
						if (var25 > 0) {
							class63 var26 = class63.field1098[var25 - 1];
					...
					if (var27 >= 0 && var27 < this.field44) {
						...
						if (var28 > 0) {
							class63 var29 = class63.field1098[var28 - 1];
						...
						if (var35 >= 1 && var35 < this.field45 - 1 && (!field42 || (this.field47[var7][var22][var35] & 0x10) == 0 && this.method21(var7, var35, var22) == field43)) {
							...
							if (var38 > 0 || var39 > 0) {
								...
								if (var7 > 0) {
									...
									if (var39 > 0 && !class63.field1098[var39 - 1].field1102) {
										var55 = false;
									}
								...
								int var56 = 0;
								if (var48 != -1) {
									var56 = class34.field649[method27(var49, 96)];
								}
								if (var39 == 0) {
									...
									class63 var59 = class63.field1098[var39 - 1];
									int var60 = var59.field1100;
									int var61;
									int var62;
									if (var60 >= 0) {
										var61 = class34.method169(var60);
										var62 = -1;
										...
										var61 = class34.field649[this.method28(var59.field1109, 96)];
									}
					...
					for (int var73 = 0; var73 <= this.field44; var73++) {
						if ((this.field59[var71][var73][var72] & var67) != 0) {
							...
							if (var80 >= 8) {
								...
								class18.method53(var70, var81, var75 * 128 + 128, var73 * 128, var73 * 128, var74 * 128, var82, 1);
						...
						if ((this.field59[var71][var73][var72] & var68) != 0) {
							...
							if (var91 >= 8) {
								...
								class18.method53(var70, var92, var72 * 128, var85 * 128, var86 * 128 + 128, var72 * 128, var93, 2);
						...
						if ((this.field59[var71][var73][var72] & var69) != 0) {
							...
							if ((var97 + 1 - var96) * (var99 + 1 - var98) >= 4) {
								...
								class18.method53(var70, var102, var99 * 128 + 128, var96 * 128, var97 * 128 + 128, var98 * 128, var102, 4);
