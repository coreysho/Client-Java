...
public final class ClientPlayer extends ClientEntity {
	...
	public Model method109() {
		...
		if (super.field430 != -1 && super.field431 != -1) {
			SpotType var2 = SpotType.field1154[super.field430];
			Model var3 = var2.method379();
			if (var3 != null) {
				Model var4 = new Model(true, AnimFrame.method48(super.field431), var3, true, false);
	...
	public Model method117() {
		if (this.field479 != null) {
			...
			if (super.field425 >= 0 && super.field428 == 0) {
				var1 = SeqType.field1133[super.field425].field1135[super.field426];
			} else if (super.field422 >= 0) {
				var1 = SeqType.field1133[super.field422].field1135[super.field423];
			}
		...
		int var8 = -1;
		if (super.field425 >= 0 && super.field428 == 0) {
			SeqType var9 = SeqType.field1133[super.field425];
			var5 = var9.field1135[super.field426];
			if (super.field422 >= 0 && super.field422 != super.field402) {
				var6 = SeqType.field1133[super.field422].field1135[super.field423];
			}
			if (var9.field1142 >= 0) {
				var7 = var9.field1142;
			...
			var5 = SeqType.field1133[super.field422].field1135[super.field423];
		}
		Model var10 = (Model) field480.method101(var3);
		if (var10 == null) {
			boolean var11 = false;
			...
			if (var11) {
				if (this.field478 != -1L) {
					var10 = (Model) field480.method101(this.field478);
				}
				if (var10 == null) {
					return null;
				}
		...
		if (var10 == null) {
			...
			for (int var16 = 0; var16 < 12; var16++) {
				...
				if (var17 >= 256 && var17 < 512) {
					Model var18 = IdkType.field1113[var17 - 256].method371();
					if (var18 != null) {
						var14[var15++] = var18;
					}
				}
		...
		var21.method127(var10, AnimFrame.method48(var5) & AnimFrame.method48(var6));
		if (var5 != -1 && var6 != -1) {
			var21.method134(SeqType.field1133[super.field425].field1139, var5, var6);
		} else if (var5 != -1) {
	...
	public Model method118() {
		...
		for (int var6 = 0; var6 < 12; var6++) {
			...
			if (var7 >= 256 && var7 < 512) {
				Model var8 = IdkType.field1113[var7 - 256].method373();
				if (var8 != null) {
					var4[var5++] = var8;
				}
			}
