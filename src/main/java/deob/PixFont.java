...
public final class PixFont extends Pix2D {
	...
	public PixFont(JagFile arg0, boolean arg1, String arg2, byte arg3) {
		...
		for (int var8 = 0; var8 < 256; var8++) {
			this.field691[var8] = var6.g1();
			this.field692[var8] = var6.g1();
			int var9 = this.field689[var8] = var6.g2();
			int var10 = this.field690[var8] = var6.g2();
			int var11 = var6.g1();
			int var12 = var9 * var10;
			this.field688[var8] = new byte[var12];
			if (var11 == 0) {
				for (int var13 = 0; var13 < var12; var13++) {
					this.field688[var8][var13] = var5.g1b();
				}
			} else if (var11 == 1) {
				for (int var14 = 0; var14 < var9; var14++) {
					for (int var15 = 0; var15 < var10; var15++) {
						this.field688[var8][var14 + var15 * var9] = var5.g1b();
					}
				}
			}
	...
	public void method205(String arg0, int arg1, boolean arg2, int arg3, int arg4, int arg5) {
		...
		if (arg1 > 0 && this.field696) {
			Pix2D.method159(arg4 - var7, 8388608, var7, var8 + (int) ((double) this.field694 * 0.7D));
		}
	}
	...
	public void method208(byte[] arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
		int var7 = arg1 + arg2 * Pix2D.field616;
	...
	public void method210(int arg0, byte[] arg1, int arg2, int arg3, int arg4, int arg5, int arg6) {
		int var8 = arg2 + arg0 * Pix2D.field616;
		int var9 = Pix2D.field616 - arg6;
		int var10 = 0;
		int var11 = 0;
		if (arg0 < Pix2D.field618) {
			int var12 = Pix2D.field618 - arg0;
			arg4 -= var12;
			arg0 = Pix2D.field618;
			var11 = var12 * arg6;
			var8 += var12 * Pix2D.field616;
		}
		if (arg0 + arg4 >= Pix2D.field619) {
			arg4 -= arg0 + arg4 + 1 - Pix2D.field619;
		}
		if (arg2 < Pix2D.field620) {
			int var13 = Pix2D.field620 - arg2;
			arg6 -= var13;
			arg2 = Pix2D.field620;
			var11 += var13;
			var8 += var13;
		...
		if (arg2 + arg6 >= Pix2D.field621) {
			int var14 = arg2 + arg6 + 1 - Pix2D.field621;
			arg6 -= var14;
			var10 += var14;
			var9 += var14;
		}
		if (arg6 > 0 && arg4 > 0) {
			this.method211(arg4, arg1, arg3, arg6, var10, arg5, var8, Pix2D.field615, var11, var9);
		}
	}
