...
@ObfuscatedName("db")
public final class class30 extends class24 {
	...
	public class30(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, boolean arg8, int arg9, int arg10, int arg11) {
		this.field498 = class68.field1154[arg7];
		this.field499 = arg6;
		this.field500 = arg0;
		this.field501 = arg11;
		this.field502 = arg9;
	...
	public void method120(int arg0) {
		...
		this.field521 += arg0;
		while (this.field521 > this.field498.field1158.method375(this.field520)) {
			this.field521 -= this.field498.field1158.method375(this.field520) + 1;
			this.field520++;
	...
	public class31 method109() {
		class31 var1 = this.field498.method379();
		if (var1 == null) {
			return null;
		}
		int var2 = -1;
		if (this.field498.field1158 != null) {
			var2 = this.field498.field1158.field1135[this.field520];
		}
		...
		if (this.field498.field1161 != 128 || this.field498.field1162 != 128) {
			var3.method141(this.field498.field1161, this.field498.field1161, this.field498.field1162);
		}
		var3.method137(this.field519);
		var3.method142(this.field498.field1164 + 64, this.field498.field1165 + 850, -30, -50, -30, true);
		return var3;
	}
}
