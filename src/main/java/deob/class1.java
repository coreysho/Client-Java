...
public class class1 extends Applet implements Runnable, MouseListener, MouseMotionListener, KeyListener, FocusListener, WindowListener {
	...
	@ObfuscatedName("a.o")
	public class43 field15;

	@ObfuscatedName("a.p")
	public final class35[] field16 = new class35[6];
	...
	public final void method1(boolean arg0, int arg1, int arg2) {
		...
		this.field12 = arg1;
		this.field13 = arg2;
		this.field17 = new class2(this, this.field12, this.field13, 0);
		this.field14 = this.method11(this.field2).getGraphics();
		this.field15 = new class43(this.field13, this.field3, this.field12, this.method11(this.field2));
