...
public final class class50 {
	...
	public void method293(byte[] arg0) {
		class38 var2 = new class38(arg0, (byte) 1);
		...
		if (var4 == var3) {
			...
			class44.method256(var5, var3, arg0, var4, 6);
			this.field864 = var5;
			var2 = new class38(this.field864, (byte) 1);
			this.field870 = true;
		}
		...
		for (int var6 = 0; var6 < this.field865; var6++) {
			if (this.field866[var6] == var3) {
				...
				if (this.field870) {
					...
					class44.method256(arg1, this.field867[var6], this.field864, this.field868[var6], this.field869[var6]);
				}
				return arg1;
			}
		}
