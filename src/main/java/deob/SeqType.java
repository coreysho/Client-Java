...
public final class SeqType {
	...
	public static void method374(JagFile arg0) {
		Packet var1 = new Packet(arg0.method294("seq.dat", null), (byte) 1);
		field1132 = var1.g2();
		if (field1133 == null) {
	...
	public int method375(int arg0) {
		...
		if (var2 == 0) {
			AnimFrame var3 = AnimFrame.method47(this.field1135[arg0]);
			if (var3 != null) {
	...
	public void method376(Packet arg0) {
		while (true) {
			int var2 = arg0.g1();
			if (var2 == 0) {
				if (this.field1134 == 0) {
			...
			if (var2 == 1) {
				...
				for (int var3 = 0; var3 < this.field1134; var3++) {
					this.field1135[var3] = arg0.g2();
					this.field1136[var3] = arg0.g2();
					if (this.field1136[var3] == 65535) {
						this.field1136[var3] = -1;
					}
					this.field1137[var3] = arg0.g2();
				}
			} else if (var2 == 2) {
				this.field1138 = arg0.g2();
			} else if (var2 == 3) {
				int var4 = arg0.g1();
				this.field1139 = new int[var4 + 1];
				for (int var5 = 0; var5 < var4; var5++) {
					this.field1139[var5] = arg0.g1();
				}
				this.field1139[var4] = 9999999;
			} else if (var2 == 4) {
				this.field1140 = true;
			} else if (var2 == 5) {
				this.field1141 = arg0.g1();
			} else if (var2 == 6) {
				this.field1142 = arg0.g2();
			} else if (var2 == 7) {
				this.field1143 = arg0.g2();
			} else if (var2 == 8) {
				this.field1144 = arg0.g1();
			} else if (var2 == 9) {
				this.field1145 = arg0.g1();
			} else if (var2 == 10) {
				this.field1146 = arg0.g1();
			} else if (var2 == 11) {
				this.field1147 = arg0.g1();
			} else {
