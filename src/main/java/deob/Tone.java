...
public final class Tone {
	...
	@ObfuscatedName("dc.e")
	public Envelope field919;

	@ObfuscatedName("dc.f")
	public Envelope field920;

	@ObfuscatedName("dc.g")
	public Envelope field921;

	@ObfuscatedName("dc.h")
	public Envelope field922;

	@ObfuscatedName("dc.i")
	public Envelope field923;

	@ObfuscatedName("dc.j")
	public Envelope field924;
	...
	@ObfuscatedName("dc.p")
	public Filter field930;

	@ObfuscatedName("dc.q")
	public Envelope field931;
	...
	public int[] method320(int arg0, int arg1) {
		...
		if (this.field930.field897[0] > 0 || this.field930.field897[1] > 0) {
			...
			if (arg0 >= var31 + var32) {
				...
				while (var33 < var34) {
					int var35 = (int) ((long) field934[var33 + var31] * (long) Filter.field904 >> 16);
					for (int var36 = 0; var36 < var31; var36++) {
						var35 += (int) ((long) field934[var33 + var31 - var36 - 1] * (long) Filter.field902[0][var36] >> 16);
					}
					for (int var37 = 0; var37 < var33; var37++) {
						var35 -= (int) ((long) field934[var33 - var37 - 1] * (long) Filter.field902[1][var37] >> 16);
					}
				...
				while (true) {
					...
					while (var33 < var38) {
						int var39 = (int) ((long) field934[var33 + var31] * (long) Filter.field904 >> 16);
						for (int var40 = 0; var40 < var31; var40++) {
							var39 += (int) ((long) field934[var33 + var31 - var40 - 1] * (long) Filter.field902[0][var40] >> 16);
						}
						for (int var41 = 0; var41 < var32; var41++) {
							var39 -= (int) ((long) field934[var33 - var41 - 1] * (long) Filter.field902[1][var41] >> 16);
						}
					...
					if (var33 >= arg0 - var31) {
						while (var33 < arg0) {
							...
							for (int var43 = var33 + var31 - arg0; var43 < var31; var43++) {
								var42 += (int) ((long) field934[var33 + var31 - var43 - 1] * (long) Filter.field902[0][var43] >> 16);
							}
							for (int var44 = 0; var44 < var32; var44++) {
								var42 -= (int) ((long) field934[var33 - var44 - 1] * (long) Filter.field902[1][var44] >> 16);
							}
	...
	public void method322(Packet arg0) {
