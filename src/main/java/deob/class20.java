...
public final class class20 {
	...
	@ObfuscatedName("t.f")
	public final class21[] field360;

	public class20(int arg0, int arg1) {
		if (arg1 != this.field356) {
			this.field355 = 236;
		}
		this.field360 = new class21[1024];
		for (int var3 = 0; var3 < 1024; var3++) {
			class21 var4 = this.field360[var3] = new class21();
			var4.field363 = var4;
			var4.field364 = var4;
		}
	}
	...
	public class21 method104(long arg0) {
		class21 var3 = this.field360[(int) (arg0 & (long) (this.field359 - 1))];
		for (class21 var4 = var3.field363; var4 != var3; var4 = var4.field363) {
	...
	public void method105(long arg0, class21 arg1) {
		if (arg1.field364 != null) {
			arg1.method106();
		}
		class21 var4 = this.field360[(int) (arg0 & (long) (this.field359 - 1))];
