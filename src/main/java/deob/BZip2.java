...
public final class BZip2 {
	...
	@ObfuscatedName("rb.a")
	public static final BZip2State field755 = new BZip2State();
	...
	public static void method257(BZip2State arg0) {
	...
	public static void method258(BZip2State arg0) {
		arg0.field780 = 1;
				...
				while (true) {
					while (var59 != var42) {
						if (var59 == 0 || var59 == 1) {
							...
							while (var60 > 0) {
								BZip2State.field789[var49] = var66 & 0xFF;
								var49++;
								var60--;
							}
						} else {
							...
							BZip2State.field789[var49] = arg0.field793[var69 & 0xFF] & 0xFF;
							var49++;
							if (var86 == 0) {
								var85++;
								var86 = 50;
					...
					for (int var83 = 0; var83 < var49; var83++) {
						byte var84 = (byte) (BZip2State.field789[var83] & 0xFF);
						BZip2State.field789[arg0.field787[var84 & 0xFF]] |= var83 << 8;
