...
public final class class57 {
	...
	@ObfuscatedName("ec.h")
	public static class38 field949;

	@ObfuscatedName("ec.i")
	public static class57[] field950;

	@ObfuscatedName("ec.j")
	public static int field951;

	@ObfuscatedName("ec.k")
	public static final class31[] field952 = new class31[4];
	...
	@ObfuscatedName("ec.T")
	public static class19 field987 = new class19(500, 0);

	@ObfuscatedName("ec.U")
	public static class19 field988 = new class19(30, 0);
	...
	public static void method323(class50 arg0) {
		field949 = new class38(arg0.method294("loc.dat", null), (byte) 1);
		class38 var1 = new class38(arg0.method294("loc.idx", null), (byte) 1);
		...
		field950 = new class57[10];
		for (int var4 = 0; var4 < 10; var4++) {
			field950[var4] = new class57();
		}
	}
	...
	public static class57 method325(int arg0) {
		...
		class57 var2 = field950[field951];
	...
	public void method327(class38 arg0) {
		int var2 = -1;
		while (true) {
			int var4;
			do {
		...
		if (this.field955 != null) {
			for (int var4 = 0; var4 < this.field955.length; var4++) {
				if (this.field955[var4] == arg0) {
					return class31.method126(this.field954[var4] & 0xFFFF);
				}
			}
			return true;
			...
			for (int var3 = 0; var3 < this.field954.length; var3++) {
				var2 &= class31.method126(this.field954[var3] & 0xFFFF);
			}
			return var2;
		} else {
			return true;
	...
	public boolean method329() {
		...
		for (int var2 = 0; var2 < this.field954.length; var2++) {
			var1 &= class31.method126(this.field954[var2] & 0xFFFF);
		}
		return var1;
	}

	@ObfuscatedName("ec.a(BLub;)V")
	public void method330(class47 arg0) {
		if (this.field954 != null) {
			for (int var2 = 0; var2 < this.field954.length; var2++) {
	...
	public class31 method331(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6) {
		class31 var8 = this.method332(arg1, arg6, arg0);
		if (var8 == null) {
			return null;
		}
		if (this.field965 || this.field966) {
			var8 = new class31(this.field966, (byte) 72, var8, this.field965);
		}
		if (this.field965) {
	...
	public class31 method332(int arg0, int arg1, int arg2) {
		class31 var4 = null;
		long var5;
		if (this.field955 == null) {
			if (arg2 != 10) {
			...
			class31 var7 = (class31) field988.method101(var5);
			if (var7 != null) {
				return var7;
			}
			if (this.field954 == null) {
			...
			for (int var10 = 0; var10 < var9; var10++) {
				...
				var4 = (class31) field987.method101((long) var11);
				if (var4 == null) {
					var4 = class31.method125(var11 & 0xFFFF);
					if (var4 == null) {
						return null;
					}
					if (var8) {
			...
			if (var9 > 1) {
				var4 = new class31(var9, -643, field952);
			}
		} else {
			int var12 = -1;
			...
			class31 var14 = (class31) field988.method101(var5);
			if (var14 != null) {
				return var14;
			}
			...
			var4 = (class31) field987.method101((long) var15);
			if (var4 == null) {
				var4 = class31.method125(var15 & 0xFFFF);
				if (var4 == null) {
					return null;
				}
				if (var16) {
		...
		class31 var19 = new class31(this.field958 == null, class7.method48(arg1), var4, true, arg0 == 0 && arg1 == -1 && !var17 && !var18);
		if (arg1 != -1) {
			var19.method132();
