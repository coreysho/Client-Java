...
public final class class60 {
	...
	@ObfuscatedName("hc.g")
	public static class38 field1036;

	@ObfuscatedName("hc.h")
	public static class60[] field1037;
	...
	@ObfuscatedName("hc.X")
	public static class19 field1079 = new class19(50, 0);

	@ObfuscatedName("hc.Y")
	public static class19 field1080 = new class19(100, 0);
	...
	public static void method339(class50 arg0) {
		field1036 = new class38(arg0.method294("obj.dat", null), (byte) 1);
		class38 var1 = new class38(arg0.method294("obj.idx", null), (byte) 1);
		...
		field1037 = new class60[10];
		for (int var4 = 0; var4 < 10; var4++) {
			field1037[var4] = new class60();
		}
	}
	...
	public static class60 method341(int arg0) {
		...
		class60 var2 = field1037[field1038];
	...
	public static class35 method347(int arg0, int arg1, int arg2) {
		if (arg1 == 0) {
			class35 var3 = (class35) field1080.method101((long) arg0);
		...
		class35 var9 = new class35(32, 32);
		int var10 = class34.field633;
		int var11 = class34.field634;
		int[] var12 = class34.field639;
		int[] var13 = class33.field615;
		int var14 = class33.field616;
		int var15 = class33.field617;
		int var16 = class33.field620;
		int var17 = class33.field621;
		int var18 = class33.field618;
		int var19 = class33.field619;
		class34.field631 = false;
		class33.method151(32, 32, var9.field661);
		class33.method156(32, 0, 32, 0, 0);
		class34.method164();
		...
		int var21 = class34.field637[var4.field1047] * var20 >> 16;
		int var22 = class34.field638[var4.field1047] * var20 >> 16;
		...
		class33.method151(var14, var15, var13);
		class33.method153(var19, var17, var16, var18);
		class34.field633 = var10;
		class34.field634 = var11;
		class34.field639 = var12;
		class34.field631 = true;
		if (var4.field1053) {
			var9.field666 = 33;
		} else {
			var9.field666 = 32;
	...
	public void method343(class38 arg0) {
		while (true) {
	...
	public void method344() {
		class60 var1 = method341(this.field1073);
		...
		class60 var2 = method341(this.field1072);
	...
	public class31 method345(int arg0) {
		...
		class31 var4 = (class31) field1079.method101((long) this.field1040);
		if (var4 != null) {
			return var4;
		}
		class31 var5 = class31.method125(this.field1041);
		if (var5 == null) {
			return null;
		}
	...
	public class31 method346(int arg0) {
		if (this.field1070 != null && arg0 > 1) {
			int var2 = -1;
			for (int var3 = 0; var3 < 10; var3++) {
				if (arg0 >= this.field1071[var3] && this.field1071[var3] != 0) {
		...
		class31 var4 = class31.method125(this.field1041);
		if (var4 == null) {
			return null;
		}
		if (this.field1044 != null) {
	...
	public boolean method348(int arg0) {
		...
		boolean var5 = true;
		if (!class31.method126(var2)) {
			var5 = false;
		}
		if (var3 != -1 && !class31.method126(var3)) {
			var5 = false;
		}
		if (var4 != -1 && !class31.method126(var4)) {
			var5 = false;
		}
		return var5;
	}
	...
	public class31 method349(int arg0) {
		int var2 = this.field1058;
		int var3 = this.field1059;
		int var4 = this.field1064;
		if (arg0 == 1) {
		...
		class31 var5 = class31.method125(var2);
		if (var3 != -1) {
			if (var4 == -1) {
				class31 var9 = class31.method125(var3);
				class31[] var10 = new class31[] { var5, var9 };
				var5 = new class31(2, -643, var10);
			} else {
				class31 var6 = class31.method125(var3);
				class31 var7 = class31.method125(var4);
				class31[] var8 = new class31[] { var5, var6, var7 };
				var5 = new class31(3, -643, var8);
			}
		}
	...
	public class31 method351(int arg0) {
		int var2 = this.field1066;
		int var3 = this.field1067;
		if (arg0 == 1) {
			var2 = this.field1068;
		...
		class31 var4 = class31.method125(var2);
		if (var3 != -1) {
			class31 var5 = class31.method125(var3);
			class31[] var6 = new class31[] { var4, var5 };
			var4 = new class31(2, -643, var6);
		}
		if (this.field1044 != null) {
