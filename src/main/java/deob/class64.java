...
public final class class64 {
	...
	@ObfuscatedName("lc.d")
	public static class64[] field1113;
	...
	public static void method368(class50 arg0) {
		class38 var1 = new class38(arg0.method294("idk.dat", null), (byte) 1);
		field1112 = var1.method226();
		if (field1113 == null) {
			field1113 = new class64[field1112];
		}
		for (int var2 = 0; var2 < field1112; var2++) {
			if (field1113[var2] == null) {
				field1113[var2] = new class64();
			}
	...
	public void method369(class38 arg0) {
		while (true) {
	...
	public boolean method370() {
		...
		for (int var2 = 0; var2 < this.field1115.length; var2++) {
			if (!class31.method126(this.field1115[var2])) {
				var1 = false;
			}
		}
		return var1;
	...
	public class31 method371() {
		...
		class31[] var1 = new class31[this.field1115.length];
		for (int var2 = 0; var2 < this.field1115.length; var2++) {
			var1[var2] = class31.method125(this.field1115[var2]);
		}
		class31 var3;
		if (var1.length == 1) {
			var3 = var1[0];
		} else {
			var3 = new class31(var1.length, -643, var1);
		}
	...
	public boolean method372() {
		...
		for (int var2 = 0; var2 < 5; var2++) {
			if (this.field1118[var2] != -1 && !class31.method126(this.field1118[var2])) {
				var1 = false;
			}
		}
		return var1;
	...
	public class31 method373() {
		...
		for (int var3 = 0; var3 < 5; var3++) {
			if (this.field1118[var3] != -1) {
				var1[var2++] = class31.method125(this.field1118[var3]);
			}
		}
		class31 var4 = new class31(var2, -643, var1);
