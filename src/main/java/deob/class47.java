...
@ObfuscatedName("ub")
public final class class47 extends class46 implements Runnable {
	...
	@ObfuscatedName("ub.v")
	public final class42 field825 = new class42((byte) 8);

	@ObfuscatedName("ub.w")
	public final class41 field826 = new class41(-822);

	@ObfuscatedName("ub.x")
	public final class41 field827 = new class41(-822);

	@ObfuscatedName("ub.y")
	public final class41 field828 = new class41(-822);

	@ObfuscatedName("ub.z")
	public final class41 field829 = new class41(-822);

	@ObfuscatedName("ub.A")
	public final class41 field830 = new class41(-822);
	...
	public void method265(class50 arg0, client arg1) {
		String[] var3 = new String[] { "model_version", "anim_version", "midi_version", "map_version" };
		for (int var4 = 0; var4 < 4; var4++) {
			byte[] var5 = arg0.method294(var3[var4], null);
			int var6 = var5.length / 2;
			class38 var7 = new class38(var5, (byte) 1);
		...
		for (int var10 = 0; var10 < 4; var10++) {
			...
			class38 var13 = new class38(var11, (byte) 1);
		...
		class38 var19 = new class38(var18, (byte) 1);
		...
		class38 var23 = new class38(var22, (byte) 1);
		...
		class38 var27 = new class38(var26, (byte) 1);
	...
	public void method274(int arg0, int arg1) {
		...
		class42 var3 = this.field825;
		synchronized (this.field825) {
			for (class39 var4 = (class39) this.field825.method250(); var4 != null; var4 = (class39) this.field825.method251(this.field806)) {
	...
	public class39 method276() {
		class41 var1 = this.field829;
		class39 var2;
		synchronized (this.field829) {
			var2 = (class39) this.field829.method242();
		}
		if (var2 == null) {
			return null;
		}
	...
	public void run() {
		try {
			while (this.field819) {
				...
				boolean var3 = false;
				for (class39 var4 = (class39) this.field828.method243(); var4 != null; var4 = (class39) this.field828.method245(this.field806)) {
					if (var4.field726) {
						var3 = true;
						var4.field725++;
						if (var4.field725 > 50) {
				...
				if (!var3) {
					for (class39 var5 = (class39) this.field828.method243(); var5 != null; var5 = (class39) this.field828.method245(this.field806)) {
						var3 = true;
						var5.field725++;
						if (var5.field725 > 50) {
							var5.field725 = 0;
	...
	public void method280() {
		class41 var1 = this.field826;
		class39 var2;
		synchronized (this.field826) {
			var2 = (class39) this.field826.method242();
		}
		while (var2 != null) {
			this.field822 = true;
			byte[] var3 = null;
			...
			class41 var4 = this.field826;
			synchronized (this.field826) {
				if (var3 == null) {
					this.field827.method240(var2);
				} else {
					var2.field724 = var3;
					class41 var5 = this.field829;
					synchronized (this.field829) {
	...
	public void method281() {
		this.field823 = 0;
		this.field824 = 0;
		for (class39 var1 = (class39) this.field828.method243(); var1 != null; var1 = (class39) this.field828.method245(this.field806)) {
			if (var1.field726) {
				this.field823++;
			} else {
				this.field824++;
		...
		while (this.field823 < 10) {
			class39 var2 = (class39) this.field827.method242();
			if (var2 == null) {
				break;
			}
	...
	public void method282() {
		while (this.field823 == 0) {
			...
			class39 var2;
			synchronized (this.field830) {
				var2 = (class39) this.field830.method242();
			}
			while (var2 != null) {
				if (this.field810[var2.field722][var2.field723] != 0) {
					this.field810[var2.field722][var2.field723] = 0;
	...
	public void method283() {
		try {
			...
			if (this.field840 == 0 && var1 >= 6) {
				...
				this.field838 = null;
				for (class39 var7 = (class39) this.field828.method243(); var7 != null; var7 = (class39) this.field828.method245(this.field806)) {
	...
	public void method285(class39 arg0) {
		try {
