...
public final class ClientBuild {
			...
			while (true) {
				while (!var8) {
					...
					if (var14 > 0 && var15 > 0 && var14 < 103 && var15 < 103) {
						...
						if (var13 != 22 || !field42 || var16.active || var16.forcedecor) {
	...
	public static void method31(World arg0, int arg1, int arg2, boolean arg3, int arg4, int arg5, int arg6, CollisionMap arg7, int[][][] arg8, int arg9, int arg10) {
		...
		if (arg5 == 22) {
			...
			if (var16.blockwalk) {
				arg7.method354(var16.width, arg10, var16.length, arg9, arg6, var16.blockrange);
			}
		} else if (arg5 >= 12) {
			ModelSource var24;
			if (var16.anim == -1) {
			...
			if (var16.blockwalk) {
				arg7.method353(arg6, arg5, var16.blockrange, arg9, arg10);
			}
		} else if (arg5 == 1) {
			ModelSource var26;
			if (var16.anim == -1) {
	...
	public void method19(int arg0, CollisionMap arg1, int arg2, int arg3, int arg4, World arg5, int arg6, int arg7) {
		...
		if (arg3 == 22) {
			if (!field42 || var14.active || var14.forcedecor) {
				ModelSource var17;
				if (var14.anim == -1) {
			...
			if (var18 != null) {
				...
				if (arg5.method60(arg7, arg4, var21, arg0, var13, var18, var16, var20, var19, var15) && var14.shadow) {
					Model var22;
			...
			if (var14.blockwalk && arg1 != null) {
				arg1.method354(var14.width, arg7, var14.length, arg4, arg2, var14.blockrange);
			}
		} else if (arg3 >= 12) {
			ModelSource var26;
			if (var14.anim == -1) {
			...
			if (var14.blockwalk && arg1 != null) {
				arg1.method353(arg2, arg3, var14.blockrange, arg4, arg7);
			}
			if (var14.wallwidth != 16) {
				arg5.method66(arg7, arg4, arg0, var14.wallwidth);
			}
		} else if (arg3 == 1) {
			ModelSource var28;
			if (var14.anim == -1) {
				...
				for (int var23 = 0; var23 < this.field45; var23++) {
					...
					if (var24 >= 0 && var24 < this.field44) {
						...
						if (var25 > 0) {
							...
							this.field54[var23] += var26.underlayHue;
							this.field55[var23] += var26.saturation;
							this.field56[var23] += var26.lightness;
							this.field57[var23] += var26.chroma;
					...
					if (var27 >= 0 && var27 < this.field44) {
						...
						if (var28 > 0) {
							...
							this.field54[var23] -= var29.underlayHue;
							this.field55[var23] -= var29.saturation;
							this.field56[var23] -= var29.lightness;
							this.field57[var23] -= var29.chroma;
							var10002 = this.field58[var23]--;
						}
					}
				}
					...
					for (int var35 = -5; var35 < this.field45 + 5; var35++) {
						...
						if (var35 >= 1 && var35 < this.field45 - 1 && (!field42 || (this.field47[var7][var22][var35] & 0x10) == 0 && this.method21(var7, var35, var22) == field43)) {
							...
							if (var38 > 0 || var39 > 0) {
								...
								int var56 = 0;
								if (var48 != -1) {
									var56 = Pix3D.colourTable[method27(var49, 96)];
								}
								if (var39 == 0) {
									...
									if (var60 >= 0) {
										...
										var62 = this.method29(var59.hue, var59.saturation, var59.lightness);
										var61 = Pix3D.colourTable[this.method28(var59.overlayHsl, 96)];
									}
