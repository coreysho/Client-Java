...
public class Component {
	...
	public static Component method207(int arg0, Packet arg1, int arg2, int arg3) {
		...
		var4.field697 = arg3;
		var4.field730 = arg0;
		var4.field718 = arg1.method398();
		var4.field771 = arg1.method398();
		var4.field724 = arg1.method400();
		var4.field723 = arg1.method400();
		var4.field720 = arg1.method400();
		if (arg2 != 10896) {
			field760 = !field760;
		}
		var4.field702 = (byte) arg1.method398();
		var4.field736 = arg1.method398();
		if (var4.field736 == 0) {
			var4.field736 = -1;
		} else {
			var4.field736 = (var4.field736 - 1 << 8) + arg1.method398();
		}
		...
		if (var5 > 0) {
			...
			for (int var6 = 0; var6 < var5; var6++) {
				var4.field755[var6] = arg1.method398();
				var4.field738[var6] = arg1.method400();
			}
		}
		...
		if (var7 > 0) {
			...
			for (int var8 = 0; var8 < var7; var8++) {
				int var9 = arg1.method400();
				var4.field716[var8] = new int[var9];
				for (int var10 = 0; var10 < var9; var10++) {
					var4.field716[var8][var10] = arg1.method400();
				}
			}
		}
		if (var4.field718 == 0) {
			var4.field767 = arg1.method400();
			var4.field701 = arg1.method398() == 1;
			int var11 = arg1.method400();
			var4.field740 = new int[var11];
			var4.field714 = new int[var11];
			var4.field758 = new int[var11];
			for (int var12 = 0; var12 < var11; var12++) {
				var4.field740[var12] = arg1.method400();
				var4.field714[var12] = arg1.method401();
				var4.field758[var12] = arg1.method401();
			}
		}
		if (var4.field718 == 1) {
			var4.field707 = arg1.method400();
			var4.field715 = arg1.method398() == 1;
		}
		if (var4.field718 == 2) {
			var4.field751 = new int[var4.field723 * var4.field720];
			var4.field706 = new int[var4.field723 * var4.field720];
			var4.field756 = arg1.method398() == 1;
			var4.field711 = arg1.method398() == 1;
			var4.field770 = arg1.method398() == 1;
			var4.field699 = arg1.method398() == 1;
			var4.field745 = arg1.method398();
			var4.field726 = arg1.method398();
			var4.field703 = new int[20];
			var4.field695 = new int[20];
			var4.field747 = new Pix32[20];
			for (int var13 = 0; var13 < 20; var13++) {
				int var15 = arg1.method398();
				if (var15 == 1) {
					var4.field703[var13] = arg1.method401();
					var4.field695[var13] = arg1.method401();
					String var16 = arg1.method405();
					if (var16.length() > 0) {
			...
			for (int var14 = 0; var14 < 5; var14++) {
				var4.field744[var14] = arg1.method405();
		...
		if (var4.field718 == 3) {
			var4.field721 = arg1.method398() == 1;
		}
		if (var4.field718 == 4 || var4.field718 == 1) {
			var4.field754 = arg1.method398() == 1;
			int var18 = arg1.method398();
			if (field705 != null) {
				var4.field719 = field705[var18];
			}
			var4.field729 = arg1.method398() == 1;
		}
		if (var4.field718 == 4) {
			var4.field712 = arg1.method405();
			var4.field731 = arg1.method405();
		}
		if (var4.field718 == 1 || var4.field718 == 3 || var4.field718 == 4) {
			var4.field722 = arg1.method403();
		}
		if (var4.field718 == 3 || var4.field718 == 4) {
			var4.field742 = arg1.method403();
			var4.field743 = arg1.method403();
			var4.field708 = arg1.method403();
		}
		if (var4.field718 == 5) {
			String var19 = arg1.method405();
			if (var19.length() > 0) {
				int var20 = var19.lastIndexOf(",");
				var4.field694 = method203(Integer.parseInt(var19.substring(var20 + 1)), var19.substring(0, var20), 373);
			}
			String var21 = arg1.method405();
			if (var21.length() > 0) {
		...
		if (var4.field718 == 6) {
			int var23 = arg1.method398();
			if (var23 != 0) {
				var4.field765 = 1;
				var4.field766 = (var23 - 1 << 8) + arg1.method398();
			}
			int var24 = arg1.method398();
			if (var24 != 0) {
				var4.field748 = 1;
				var4.field749 = (var24 - 1 << 8) + arg1.method398();
			}
			int var25 = arg1.method398();
			if (var25 == 0) {
				var4.field768 = -1;
			} else {
				var4.field768 = (var25 - 1 << 8) + arg1.method398();
			}
			int var26 = arg1.method398();
			if (var26 == 0) {
				var4.field769 = -1;
			} else {
				var4.field769 = (var26 - 1 << 8) + arg1.method398();
			}
			var4.field733 = arg1.method400();
			var4.field734 = arg1.method400();
			var4.field735 = arg1.method400();
		}
		if (var4.field718 == 7) {
			var4.field751 = new int[var4.field723 * var4.field720];
			var4.field706 = new int[var4.field723 * var4.field720];
			var4.field754 = arg1.method398() == 1;
			int var27 = arg1.method398();
			if (field705 != null) {
				var4.field719 = field705[var27];
			}
			var4.field729 = arg1.method398() == 1;
			var4.field722 = arg1.method403();
			var4.field745 = arg1.method401();
			var4.field726 = arg1.method401();
			var4.field711 = arg1.method398() == 1;
			var4.field744 = new String[5];
			for (int var28 = 0; var28 < 5; var28++) {
				var4.field744[var28] = arg1.method405();
		...
		if (var4.field771 == 2 || var4.field718 == 2) {
			var4.field763 = arg1.method405();
			var4.field693 = arg1.method405();
			var4.field704 = arg1.method400();
		}
		if (var4.field771 == 1 || var4.field771 == 4 || var4.field771 == 5 || var4.field771 == 6) {
			var4.field750 = arg1.method405();
	...
	public static void method208(int arg0, PixFont[] arg1, Jagfile arg2, Jagfile arg3) {
		...
		int var6 = var5.method400();
		field698 = new Component[var6];
		field764 = new byte[var6][];
		while (var5.field1280 < var5.field1279.length) {
			int var7 = var5.method400();
			if (var7 == 65535) {
				var4 = var5.method400();
				var7 = var5.method400();
			}
			int var8 = var5.field1280;
			Component var9 = method207(var4, var5, 10896, var7);
			byte[] var10 = field764[var9.field697] = new byte[var5.field1280 - var8 + 2];
			for (int var11 = var8; var11 < var5.field1280; var11++) {
				var10[var11 - var8 + 2] = var5.field1279[var11];
			}
			var10[0] = (byte) (var4 >> 8);
			var10[1] = (byte) var4;
		}
