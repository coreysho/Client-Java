...
public final class Pix3D extends Pix2D {
	...
	@ObfuscatedName("hb.M")
	public static boolean[] texTrans;

	@ObfuscatedName("hb.N")
	public static int[] texAverage;

	@ObfuscatedName("hb.Q")
	public static int[][] activeTexels;

	@ObfuscatedName("hb.R")
	public static int[] texCycle;

	@ObfuscatedName("hb.T")
	public static int[] colourTable;

	@ObfuscatedName("hb.U")
	public static int[][] texPal;
	...
	static {
		...
		texTrans = new boolean[50];
		texAverage = new int[50];
	...
	public static int[] getTexels(int arg0) {
		...
		if (poolSize > 0) {
			...
			int var2 = 0;
			int var3 = -1;
			for (int var4 = 0; var4 < numTextures; var4++) {
				if (activeTexels[var4] != null && (texCycle[var4] < var2 || var3 == -1)) {
					var2 = texCycle[var4];
					var3 = var4;
				}
			}
						...
						while (true) {
							...
							if (var22 < 0) {
								while (true) {
									...
									gouraudRaster(Pix2D.pixels, var23, var16 >> 16, var19 >> 16, var18 >> 7, var20 >> 7);
									var16 += var13;
									var19 += var11;
									var18 += var14;
									var20 += var12;
							...
							gouraudRaster(Pix2D.pixels, var23, var16 >> 16, var15 >> 16, var18 >> 7, var17 >> 7);
							var16 += var13;
							var15 += var9;
							var18 += var14;
							var17 += var10;
						...
						while (true) {
							...
							if (var25 < 0) {
								while (true) {
									...
									gouraudRaster(Pix2D.pixels, var26, var19 >> 16, var16 >> 16, var20 >> 7, var18 >> 7);
									var16 += var13;
									var19 += var11;
									var18 += var14;
									var20 += var12;
							...
							gouraudRaster(Pix2D.pixels, var26, var15 >> 16, var16 >> 16, var17 >> 7, var18 >> 7);
							var16 += var13;
							var15 += var9;
							var18 += var14;
							var17 += var10;
						...
						while (true) {
							...
							if (var34 < 0) {
								while (true) {
									...
									gouraudRaster(Pix2D.pixels, var35, var31 >> 16, var27 >> 16, var32 >> 7, var29 >> 7);
									var31 += var11;
									var27 += var9;
									var32 += var12;
									var29 += var10;
							...
							gouraudRaster(Pix2D.pixels, var35, var28 >> 16, var27 >> 16, var30 >> 7, var29 >> 7);
							var28 += var13;
							var27 += var9;
							var30 += var14;
							var29 += var10;
						...
						while (true) {
							...
							if (var37 < 0) {
								while (true) {
									...
									gouraudRaster(Pix2D.pixels, var38, var27 >> 16, var31 >> 16, var29 >> 7, var32 >> 7);
									var31 += var11;
									var27 += var9;
									var32 += var12;
									var29 += var10;
							...
							gouraudRaster(Pix2D.pixels, var38, var27 >> 16, var28 >> 16, var29 >> 7, var30 >> 7);
							var28 += var13;
							var27 += var9;
							var30 += var14;
							var29 += var10;
						...
						while (true) {
							...
							if (var46 < 0) {
								while (true) {
									...
									gouraudRaster(Pix2D.pixels, var47, var40 >> 16, var43 >> 16, var42 >> 7, var44 >> 7);
									var40 += var9;
									var43 += var13;
									var42 += var10;
									var44 += var14;
							...
							gouraudRaster(Pix2D.pixels, var47, var40 >> 16, var39 >> 16, var42 >> 7, var41 >> 7);
							var40 += var9;
							var39 += var11;
							var42 += var10;
							var41 += var12;
						...
						while (true) {
							...
							if (var49 < 0) {
								while (true) {
									...
									gouraudRaster(Pix2D.pixels, var50, var43 >> 16, var40 >> 16, var44 >> 7, var42 >> 7);
									var40 += var9;
									var43 += var13;
									var42 += var10;
									var44 += var14;
							...
							gouraudRaster(Pix2D.pixels, var50, var39 >> 16, var40 >> 16, var41 >> 7, var42 >> 7);
							var40 += var9;
							var39 += var11;
							var42 += var10;
							var41 += var12;
						...
						while (true) {
							...
							if (var58 < 0) {
								while (true) {
									...
									gouraudRaster(Pix2D.pixels, var59, var55 >> 16, var51 >> 16, var56 >> 7, var53 >> 7);
									var55 += var13;
									var51 += var11;
									var56 += var14;
									var53 += var12;
							...
							gouraudRaster(Pix2D.pixels, var59, var52 >> 16, var51 >> 16, var54 >> 7, var53 >> 7);
							var52 += var9;
							var51 += var11;
							var54 += var10;
							var53 += var12;
						...
						while (true) {
							...
							if (var61 < 0) {
								while (true) {
									...
									gouraudRaster(Pix2D.pixels, var62, var51 >> 16, var55 >> 16, var53 >> 7, var56 >> 7);
									var55 += var13;
									var51 += var11;
									var56 += var14;
									var53 += var12;
							...
							gouraudRaster(Pix2D.pixels, var62, var51 >> 16, var52 >> 16, var53 >> 7, var54 >> 7);
							var52 += var9;
							var51 += var11;
							var54 += var10;
							var53 += var12;
					...
					while (true) {
						...
						if (var70 < 0) {
							while (true) {
								...
								gouraudRaster(Pix2D.pixels, var71, var64 >> 16, var67 >> 16, var66 >> 7, var68 >> 7);
								var64 += var11;
								var67 += var9;
								var66 += var12;
								var68 += var10;
						...
						gouraudRaster(Pix2D.pixels, var71, var64 >> 16, var63 >> 16, var66 >> 7, var65 >> 7);
						var64 += var11;
						var63 += var13;
						var66 += var12;
						var65 += var14;
					...
					while (true) {
						...
						if (var73 < 0) {
							while (true) {
								...
								gouraudRaster(Pix2D.pixels, var74, var67 >> 16, var64 >> 16, var68 >> 7, var66 >> 7);
								var64 += var11;
								var67 += var9;
								var66 += var12;
								var68 += var10;
						...
						gouraudRaster(Pix2D.pixels, var74, var63 >> 16, var64 >> 16, var65 >> 7, var66 >> 7);
						var64 += var11;
						var63 += var13;
						var66 += var12;
						var65 += var14;
					...
					while (true) {
						...
						if (var82 < 0) {
							while (true) {
								...
								gouraudRaster(Pix2D.pixels, var83, var79 >> 16, var75 >> 16, var80 >> 7, var77 >> 7);
								var79 += var9;
								var75 += var13;
								var80 += var10;
								var77 += var14;
						...
						gouraudRaster(Pix2D.pixels, var83, var76 >> 16, var75 >> 16, var78 >> 7, var77 >> 7);
						var76 += var11;
						var75 += var13;
						var78 += var12;
						var77 += var14;
					...
					while (true) {
						...
						if (var85 < 0) {
							while (true) {
								...
								gouraudRaster(Pix2D.pixels, var86, var75 >> 16, var79 >> 16, var77 >> 7, var80 >> 7);
								var79 += var9;
								var75 += var13;
								var80 += var10;
								var77 += var14;
						...
						gouraudRaster(Pix2D.pixels, var86, var75 >> 16, var76 >> 16, var77 >> 7, var78 >> 7);
						var76 += var11;
						var75 += var13;
						var78 += var12;
						var77 += var14;
